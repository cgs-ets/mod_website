 ...
 *
 * @module     mod_website/grading_navigation_user_info
 * @package    mod_website
 * @class      UserInfo
...
define(['jquery', 'core/notification', 'core/ajax', 'core/templates'], function ($, notification, ajax, templates) {
    ...
    /**
     * Get the mod_website id
     *
     * @private
     * @method _getWebsiteId
     * @return {Integer} id
     */
    UserInfo.prototype._getWebsiteId = function () {
        return this._region.attr('data-websiteid');
    };
    ...
    UserInfo.prototype._refreshUserInfo = function (event, userid) {
        ...
        templates.render('mod_website/loading', {}).done(function (html, js) {
            // Update the page.
            ...
            if (userid == 0) {
                // Render the template.
                templates.render('mod_website/grading_navigation_no_users', {}).done(function (html, js) {
            ...
            if (typeof this._userCache[userid] !== "undefined") {
                ...
                var websiteid = this._getWebsiteId();
                var requests = ajax.call([{
                    methodname: 'mod_website_get_participant',
                    args: {
                        userid: userid,
                        websiteid: websiteid
                    }
            ...
            promise.done(function (context) {
                ...
                templates.render('mod_website/grading_navigation_user_summary', context).done(function (html, js) {
                    // Update the page.
                    if (userid == this._lastUserId) {
                        this._region.fadeOut("fast", function () {
                            templates.replaceNodeContents(this._region, html, js);
